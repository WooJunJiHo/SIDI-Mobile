                ...
                <TouchableOpacity
                    ...
                    onPress={() => {
                        ...
                        const fetchPrice = async () => {
                            ...
                            await assetList.push({ AssetsID: addResult.id, COMPANY: asset.COMPANY, MODEL: asset.MODEL, MORE: asset.MORE, COLOR: rgb.color, GPTCONTENT: null, UserID: user.userID, CategoryID: asset.CATEGORY, PRICE: filteredList[filteredList.length - 1].value, CONDITIONS: '이상 없음', GPTCONTENT: gptRes, DATE: new Date() })
